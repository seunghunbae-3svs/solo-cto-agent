...
echo ""
echo "═══ Visual Review (UI/UX screenshot analysis) ═══"
echo ""
echo "  The review engine uses Playwright to capture screenshots of"
echo "  deployed previews for Claude Vision UI/UX analysis."
echo "  Playwright is auto-installed in GitHub Actions (cross-review-dispatch.yml)."
echo ""
echo "  For local testing:"
echo "    npm install playwright"
echo "    npx playwright install chromium"
echo ""
echo "  If Playwright is not available, visual review is gracefully skipped."
echo "  To enable Vercel preview screenshots, also set:"
echo "    gh secret set VERCEL_TOKEN  (get at: https://vercel.com/account/tokens)"
echo ""
